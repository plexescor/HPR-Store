...
using Qt_ScrollPhase = unsigned int;
...
constexpr static const Qt_Key Qt_Key_Key_micro = 181;
...
constexpr static const Qt_ScrollPhase Qt_ScrollPhase_NoScrollPhase = 0;

constexpr static const Qt_ScrollPhase Qt_ScrollPhase_ScrollBegin = 1;

constexpr static const Qt_ScrollPhase Qt_ScrollPhase_ScrollUpdate = 2;

constexpr static const Qt_ScrollPhase Qt_ScrollPhase_ScrollEnd = 3;

constexpr static const Qt_ScrollPhase Qt_ScrollPhase_ScrollMomentum = 4;
